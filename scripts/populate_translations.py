...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "Ignore all existing tags": "Alle vorhandenen Tags ignorieren",
    ...
    "fr": {
        ...
        "Ignore all existing tags": "Ignorer tous les tags existants",
    ...
    "it": {
        ...
        "Ignore all existing tags": "Ignora tutti i tag esistenti",
    ...
    "rm": {
        ...
        "Ignore all existing tags": "Ignorar tut ils tags existents",
...
TRANSLATIONS["de"].update({
    ...
    "This image has no AI vector. Run AI Full Rescan to generate tag suggestions.": "Dieses Bild hat keinen KI-Vektor. Führen Sie einen vollständigen KI-Neuscan aus, um Tag-Vorschläge zu erzeugen.",
    "TGM vectors are out of date. Rebuild them to generate tag suggestions.": "Die TGM-Vektoren sind veraltet. Erstellen Sie sie neu, um Tag-Vorschläge zu erzeugen.",
    "No tag suggestions met the current confidence threshold.": "Keine Tag-Vorschläge haben den aktuellen Konfidenzschwellenwert erreicht.",
...
TRANSLATIONS["fr"].update({
    ...
    "This image has no AI vector. Run AI Full Rescan to generate tag suggestions.": "Cette image n’a pas de vecteur IA. Lancez une réanalyse IA complète pour générer des propositions de tags.",
    "TGM vectors are out of date. Rebuild them to generate tag suggestions.": "Les vecteurs TGM sont obsolètes. Recréez-les pour générer des propositions de tags.",
    "No tag suggestions met the current confidence threshold.": "Aucune proposition de tag n’a atteint le seuil de confiance actuel.",
...
TRANSLATIONS["it"].update({
    ...
    "This image has no AI vector. Run AI Full Rescan to generate tag suggestions.": "Questa immagine non ha un vettore IA. Esegui una nuova scansione IA completa per generare proposte di tag.",
    "TGM vectors are out of date. Rebuild them to generate tag suggestions.": "I vettori TGM non sono aggiornati. Ricreali per generare proposte di tag.",
    "No tag suggestions met the current confidence threshold.": "Nessuna proposta di tag ha raggiunto la soglia di confidenza attuale.",
...
TRANSLATIONS["rm"].update({
    ...
    "This image has no AI vector. Run AI Full Rescan to generate tag suggestions.": "Quest maletg n'ha nagin vector dad IA. Exequì ina nova scansiun cumpletta dad IA per generar propostas da tags.",
    "TGM vectors are out of date. Rebuild them to generate tag suggestions.": "Ils vectors TGM èn antiquads. Creai els da nov per generar propostas da tags.",
    "No tag suggestions met the current confidence threshold.": "Naginas propostas da tags han cuntanschì la sava da confidenza actuala.",
...
TRANSLATIONS["de"].update({
    ...
    "Choose a valid copy target.": "W\u00e4hlen Sie ein g\u00fcltiges Kopierziel aus.",
    "Choose whether to add or replace tags.": "W\u00e4hlen Sie, ob Tags hinzugef\u00fcgt oder ersetzt werden sollen.",
    "Close": "Schlie\u00dfen",
    "Copies accepted and custom tags. The current image is excluded.": "Kopiert akzeptierte und benutzerdefinierte Tags. Das aktuelle Bild ist ausgeschlossen.",
    "Copy Tags": "Tags kopieren",
    "Copy tags to other images": "Tags auf andere Bilder kopieren",
    "Copied tags to {} image(s). Unchanged: {}. Problems: {}.": "Tags auf {} Bild(er) kopiert. Unver\u00e4ndert: {}. Probleme: {}.",
    "Copying tags": "Tags werden kopiert",
    "Current folder (%1)": "Aktueller Ordner (%1)",
    "Current search results (%1)": "Aktuelle Suchergebnisse (%1)",
    "Derivative Generation Complete": "Derivaterstellung abgeschlossen",
    "Enable AI features first": "Aktivieren Sie zuerst die KI-Funktionen",
    "Enable tagging for this database": "Verschlagwortung f\u00fcr diese Datenbank aktivieren",
    "Metadata language": "Metadatensprache",
    "Export TGM labels": "TGM-Bezeichnungen exportieren",
    "Canonical English": "Kanonisches Englisch",
    "Interface language": "Oberfl\u00e4chensprache",
    "Selected languages": "Ausgew\u00e4hlte Sprachen",
    "Install Translation Pack": "\u00dcbersetzungspaket installieren",
    "Select TGM translation pack": "TGM-\u00dcbersetzungspaket ausw\u00e4hlen",
    "TGM translation packs (*.json *.json.gz)": "TGM-\u00dcbersetzungspakete (*.json *.json.gz)",
    "Generate Tagged Derivatives for &Marked Images (%1 selected)": "Verschlagwortete Derivate f\u00fcr &markierte Bilder erzeugen (%1 ausgew\u00e4hlt)",
    "Generate Tagged Derivatives for Current &Results...": "Verschlagwortete Derivate f\u00fcr aktuelle &Ergebnisse erzeugen...",
    "Generating Tagged Derivatives": "Verschlagwortete Derivate werden erzeugt",
    "Keep target tags and add missing source tags": "Tags der Zielbilder beibehalten und fehlende Quell-Tags hinzuf\u00fcgen",
    "Open tagging (Ctrl+T)": "Verschlagwortung \u00f6ffnen (Ctrl+T)",
    "Proposal threshold": "Vorschlagsschwellenwert",
    "Developer diagnostics: show raw top 20 candidates": "Entwicklerdiagnose: unfilterte Top-20-Kandidaten anzeigen",
    "Cosine similarity": "Kosinusähnlichkeit",
    "Rebuild Vectors": "Vektoren neu erstellen",
    "Remove target tags before copying source tags": "Tags der Zielbilder vor dem Kopieren der Quell-Tags entfernen",
    "Replace": "Ersetzen",
    "Replace tags on target images?": "Tags auf Zielbildern ersetzen?",
    "Source date: %1": "Quelldatum: %1",
    "TGM is not installed": "TGM ist nicht installiert",
    "TGM ready: %1 subjects, %2 genre/form terms": "TGM bereit: %1 Sachbegriffe, %2 Genre-/Formbegriffe",
    "TGM vectors are current": "TGM-Vektoren sind aktuell",
    "TGM vectors are required": "TGM-Vektoren sind erforderlich",
...
TRANSLATIONS["fr"].update({
    ...
    "Choose a valid copy target.": "Choisissez une cible de copie valide.",
    "Choose whether to add or replace tags.": "Choisissez d\u2019ajouter ou de remplacer les tags.",
    "Close": "Fermer",
    "Copies accepted and custom tags. The current image is excluded.": "Copie les tags accept\u00e9s et personnalis\u00e9s. L\u2019image actuelle est exclue.",
    "Copy Tags": "Copier les tags",
    "Copy tags to other images": "Copier les tags vers d\u2019autres images",
    "Copied tags to {} image(s). Unchanged: {}. Problems: {}.": "Tags copi\u00e9s vers {} image(s). Inchang\u00e9es : {}. Probl\u00e8mes : {}.",
    "Copying tags": "Copie des tags",
    "Current folder (%1)": "Dossier actuel (%1)",
    "Current search results (%1)": "R\u00e9sultats de recherche actuels (%1)",
    "Derivative Generation Complete": "G\u00e9n\u00e9ration des d\u00e9riv\u00e9s termin\u00e9e",
    "Enable AI features first": "Activez d\u2019abord les fonctionnalit\u00e9s d\u2019IA",
    "Enable tagging for this database": "Activer l\u2019\u00e9tiquetage pour cette base de donn\u00e9es",
    "Metadata language": "Langue des m\u00e9tadonn\u00e9es",
    "Export TGM labels": "Exporter les libell\u00e9s TGM",
    "Canonical English": "Anglais canonique",
    "Interface language": "Langue de l\u2019interface",
    "Selected languages": "Langues s\u00e9lectionn\u00e9es",
    "Install Translation Pack": "Installer un pack de traduction",
    "Select TGM translation pack": "S\u00e9lectionner un pack de traduction TGM",
    "TGM translation packs (*.json *.json.gz)": "Packs de traduction TGM (*.json *.json.gz)",
    "Generate Tagged Derivatives for &Marked Images (%1 selected)": "G\u00e9n\u00e9rer des d\u00e9riv\u00e9s \u00e9tiquet\u00e9s pour les images &marqu\u00e9es (%1 s\u00e9lectionn\u00e9es)",
    "Generate Tagged Derivatives for Current &Results...": "G\u00e9n\u00e9rer des d\u00e9riv\u00e9s \u00e9tiquet\u00e9s pour les &r\u00e9sultats actuels...",
    "Generating Tagged Derivatives": "G\u00e9n\u00e9ration des d\u00e9riv\u00e9s \u00e9tiquet\u00e9s",
    "Keep target tags and add missing source tags": "Conserver les tags cibles et ajouter les tags source manquants",
    "Open tagging (Ctrl+T)": "Ouvrir l\u2019\u00e9tiquetage (Ctrl+T)",
    "Proposal threshold": "Seuil de proposition",
    "Developer diagnostics: show raw top 20 candidates": "Diagnostic développeur : afficher les 20 premiers candidats bruts",
    "Cosine similarity": "Similarité cosinus",
    "Rebuild Vectors": "Recr\u00e9er les vecteurs",
    "Remove target tags before copying source tags": "Supprimer les tags cibles avant de copier les tags source",
    "Replace": "Remplacer",
    "Replace tags on target images?": "Remplacer les tags des images cibles ?",
    "Source date: %1": "Date de la source : %1",
    "TGM is not installed": "TGM n\u2019est pas install\u00e9",
    "TGM ready: %1 subjects, %2 genre/form terms": "TGM pr\u00eat : %1 sujets, %2 termes de genre/forme",
    "TGM vectors are current": "Les vecteurs TGM sont \u00e0 jour",
    "TGM vectors are required": "Les vecteurs TGM sont requis",
...
TRANSLATIONS["it"].update({
    ...
    "Choose a valid copy target.": "Scegli una destinazione di copia valida.",
    "Choose whether to add or replace tags.": "Scegli se aggiungere o sostituire i tag.",
    "Close": "Chiudi",
    "Copies accepted and custom tags. The current image is excluded.": "Copia i tag accettati e personalizzati. L\u2019immagine corrente \u00e8 esclusa.",
    "Copy Tags": "Copia tag",
    "Copy tags to other images": "Copia i tag in altre immagini",
    "Copied tags to {} image(s). Unchanged: {}. Problems: {}.": "Tag copiati in {} immagine/i. Invariate: {}. Problemi: {}.",
    "Copying tags": "Copia dei tag",
    "Current folder (%1)": "Cartella corrente (%1)",
    "Current search results (%1)": "Risultati di ricerca correnti (%1)",
    "Derivative Generation Complete": "Generazione dei derivati completata",
    "Enable AI features first": "Abilita prima le funzionalit\u00e0 IA",
    "Enable tagging for this database": "Abilita i tag per questo database",
    "Metadata language": "Lingua dei metadati",
    "Export TGM labels": "Esporta etichette TGM",
    "Canonical English": "Inglese canonico",
    "Interface language": "Lingua dell\u2019interfaccia",
    "Selected languages": "Lingue selezionate",
    "Install Translation Pack": "Installa pacchetto di traduzione",
    "Select TGM translation pack": "Seleziona pacchetto di traduzione TGM",
    "TGM translation packs (*.json *.json.gz)": "Pacchetti di traduzione TGM (*.json *.json.gz)",
    "Generate Tagged Derivatives for &Marked Images (%1 selected)": "Genera derivati con tag per le immagini &contrassegnate (%1 selezionate)",
    "Generate Tagged Derivatives for Current &Results...": "Genera derivati con tag per i &risultati correnti...",
    "Generating Tagged Derivatives": "Generazione dei derivati con tag",
    "Keep target tags and add missing source tags": "Mantieni i tag di destinazione e aggiungi quelli sorgente mancanti",
    "Open tagging (Ctrl+T)": "Apri i tag (Ctrl+T)",
    "Proposal threshold": "Soglia delle proposte",
    "Developer diagnostics: show raw top 20 candidates": "Diagnostica sviluppatore: mostra i primi 20 candidati grezzi",
    "Cosine similarity": "Similarità del coseno",
    "Rebuild Vectors": "Ricrea vettori",
    "Remove target tags before copying source tags": "Rimuovi i tag di destinazione prima di copiare quelli sorgente",
    "Replace": "Sostituisci",
    "Replace tags on target images?": "Sostituire i tag nelle immagini di destinazione?",
    "Source date: %1": "Data sorgente: %1",
    "TGM is not installed": "TGM non \u00e8 installato",
    "TGM ready: %1 subjects, %2 genre/form terms": "TGM pronto: %1 soggetti, %2 termini di genere/forma",
    "TGM vectors are current": "I vettori TGM sono aggiornati",
    "TGM vectors are required": "Sono necessari i vettori TGM",
...
TRANSLATIONS["rm"].update({
    ...
    "Choose a valid copy target.": "Tscherna ina destinaziun valida per copiar.",
    "Choose whether to add or replace tags.": "Tscherna sche tags duain vegnir agiuntads u remplazzads.",
    "Close": "Serrar",
    "Copies accepted and custom tags. The current image is excluded.": "Copia tags acceptads e persunalisads. Il maletg actual \u00e8 exclus.",
    "Copy Tags": "Copiar tags",
    "Copy tags to other images": "Copiar tags sin auters maletgs",
    "Copied tags to {} image(s). Unchanged: {}. Problems: {}.": "Tags copiads sin {} maletg(s). Betg mid\u00e0: {}. Problems: {}.",
    "Copying tags": "Tags vegnan copiads",
    "Current folder (%1)": "Cartella actuala (%1)",
    "Current search results (%1)": "Resultats da tschertga actuals (%1)",
    "Derivative Generation Complete": "Generaziun dals derivats terminada",
    "Enable AI features first": "Activescha l\u2019emprim las funcziuns dad IA",
    "Enable tagging for this database": "Activar tags per questa banca da datas",
    "Metadata language": "Lingua da las metadatas",
    "Export TGM labels": "Exportar denominaziuns TGM",
    "Canonical English": "Englais canonic",
    "Interface language": "Lingua da l\u2019interfatscha",
    "Selected languages": "Linguas tschernidas",
    "Install Translation Pack": "Installar il pachet da translaziuns",
    "Select TGM translation pack": "Tscherner il pachet da translaziuns TGM",
    "TGM translation packs (*.json *.json.gz)": "Pachets da translaziuns TGM (*.json *.json.gz)",
    "Generate Tagged Derivatives for &Marked Images (%1 selected)": "Generar derivats cun tags per maletgs &marcads (%1 selecziunads)",
    "Generate Tagged Derivatives for Current &Results...": "Generar derivats cun tags per ils &resultats actuals...",
    "Generating Tagged Derivatives": "Derivats cun tags vegnan generads",
    "Keep target tags and add missing source tags": "Mantegna ils tags da destinaziun ed agiunta tags da funtauna mancants",
    "Open tagging (Ctrl+T)": "Avrir la chavazzinaziun (Ctrl+T)",
    "Proposal threshold": "Limita da propostas",
    "Developer diagnostics: show raw top 20 candidates": "Diagnostica per sviluppaders: mussar ils 20 megliers candidats betg filtrads",
    "Cosine similarity": "Sumeglientscha da cosinus",
    "Rebuild Vectors": "Crear vectors danovamain",
    "Remove target tags before copying source tags": "Allontanar ils tags da destinaziun avant che copiar ils tags da funtauna",
    "Replace": "Remplazzar",
    "Replace tags on target images?": "Remplazzar ils tags sin ils maletgs da destinaziun?",
    "Source date: %1": "Data da funtauna: %1",
    "TGM is not installed": "TGM n\u2019\u00e8 betg install\u00e0",
    "TGM ready: %1 subjects, %2 genre/form terms": "TGM pront: %1 subjects, %2 terms da gener/furma",
    "TGM vectors are current": "Ils vectors TGM \u00e8n actuals",
    "TGM vectors are required": "Ils vectors TGM \u00e8n necessaris",
...
TRANSLATIONS["de"].update({
    "Add a Wikidata term": "Einen Wikidata-Begriff hinzuf\u00fcgen",
    "Build Wikidata Vectors": "Wikidata-Vektoren erstellen",
    "Build Wikidata vectors to generate proposals.": "Erstellen Sie Wikidata-Vektoren, um Vorschl\u00e4ge zu erzeugen.",
    "Building Wikidata vectors": "Wikidata-Vektoren werden erstellt",
    "Building controlled-vocabulary vectors": "Vektoren des kontrollierten Vokabulars werden erstellt",
    "Bundled Wikidata snapshot: %1 subjects, %2 genre/form terms": "Geb\u00fcndelter Wikidata-Snapshot: %1 Sachbegriffe, %2 Genre-/Formbegriffe",
...
TRANSLATIONS["fr"].update({
    "Add a Wikidata term": "Ajouter un terme Wikidata",
    "Build Wikidata Vectors": "Cr\u00e9er les vecteurs Wikidata",
    "Build Wikidata vectors to generate proposals.": "Cr\u00e9ez les vecteurs Wikidata pour g\u00e9n\u00e9rer des propositions.",
    "Building Wikidata vectors": "Cr\u00e9ation des vecteurs Wikidata",
    "Building controlled-vocabulary vectors": "Cr\u00e9ation des vecteurs du vocabulaire contr\u00f4l\u00e9",
    "Bundled Wikidata snapshot: %1 subjects, %2 genre/form terms": "Instantan\u00e9 Wikidata int\u00e9gr\u00e9 : %1 sujets, %2 termes de genre/forme",
...
TRANSLATIONS["it"].update({
    "Add a Wikidata term": "Aggiungi un termine Wikidata",
    "Build Wikidata Vectors": "Crea vettori Wikidata",
    "Build Wikidata vectors to generate proposals.": "Crea i vettori Wikidata per generare proposte.",
    "Building Wikidata vectors": "Creazione dei vettori Wikidata",
    "Building controlled-vocabulary vectors": "Creazione dei vettori del vocabolario controllato",
    "Bundled Wikidata snapshot: %1 subjects, %2 genre/form terms": "Snapshot Wikidata incluso: %1 soggetti, %2 termini di genere/forma",
...
TRANSLATIONS["rm"].update({
    "Add a Wikidata term": "Agiuntar in term Wikidata",
    "Build Wikidata Vectors": "Crear vectors Wikidata",
    "Build Wikidata vectors to generate proposals.": "Crear vectors Wikidata per generar propostas.",
    "Building Wikidata vectors": "Vectors Wikidata vegnan creads",
    "Building controlled-vocabulary vectors": "Vectors dal vocabular controll\u00e0 vegnan creads",
    "Bundled Wikidata snapshot: %1 subjects, %2 genre/form terms": "Snapshot Wikidata integr\u00e0: %1 subjects, %2 terms da gener/furma",
